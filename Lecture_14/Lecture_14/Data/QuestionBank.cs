...
namespace Lecture_14.Data;

public static class QuestionBank
{
    private static Random random = new Random();

    public static IEnumerable<Question> Randomize(int count) => (All.Count < count) ? All: AllShuffled.Take(count);
     
    public static Question PickOne() => All[random.Next(0, All.Count)];
    ...
    public static List<Question> GetQuestionRange(IEnumerable<int> range) => All.Where((x, i) => range.Contains(i)).ToList();
