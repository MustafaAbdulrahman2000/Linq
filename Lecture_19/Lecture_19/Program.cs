using Lecture_19.Data;
using Lecture_19.Extensions;
...
var page1x7 = employees.Paginate(null, 7);

page1x7.Print("page #1  [7 emps]");


// Pagination with filtering examples

var page1x7Covered = employees.PaginateWithWhere(x => x.HasHealthInsurance, 1, 7);
